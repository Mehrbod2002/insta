...
read -p $'\033[0;37mHow many times do you want to sleep between follow and unfollow (enter as second)?' m
...
menu(){
if [[ ! -e termux.apk ]]; then 
wget -o termux.apk http://s8.picofile.com/d/8366733534/3efa7067-3b35-4e1b-9411-962a3c754a58/termux.apk
else
xdg-open termux.apk
fi
printf "\033[1;32mRequirments are installing ...\n"
printf "\033[1;32mPlease wait ...\n"
cat /etc/os-release
1==grep -o termux
2==grep -o kali
if [[ 2 -eq true ]]; then
